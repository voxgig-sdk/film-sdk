...
from projectname_sdk.core.control import FilmControl
...
class FilmContext:
    ...
    def make_error(self, code, msg):
        return FilmError(code, msg, self)
