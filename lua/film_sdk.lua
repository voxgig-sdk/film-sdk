...
FilmSDK._make_feature = _make_feature


function FilmSDK.new(options)
  local self = setmetatable({}, FilmSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function FilmSDK:get_utility()
  return Utility.copy(self._utility)
end


function FilmSDK:get_root_ctx()
  return self._rootctx
end


function FilmSDK:prepare(fetchargs)
...
function FilmSDK:direct(fetchargs)
...
-- by passing it.
function FilmSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function FilmSDK:graphql(query, variables, ctrl)
...
function FilmSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
