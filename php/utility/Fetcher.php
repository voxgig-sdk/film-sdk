...
class FilmFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FilmSDK/1.0)';
    ...
    public static function call(FilmContext $ctx, string $fullurl, array $fetchdef): array
    {
