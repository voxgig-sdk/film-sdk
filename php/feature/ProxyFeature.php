...
class FilmProxyFeature extends FilmBaseFeature
{
    ...
    public function init(FilmContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FilmContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
