...
class FilmNetsimFeature extends FilmBaseFeature
{
    ...
    private function _simulate(FilmContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FilmContext $ctx, array $applied): void
    {
        $client = $this->client;
