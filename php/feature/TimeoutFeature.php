...
class FilmTimeoutFeature extends FilmBaseFeature
{
    ...
    private function _with_timeout(FilmContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FilmContext $_ctx, float $ms): void
    {
        $client = $this->client;
