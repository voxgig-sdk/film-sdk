...
class FilmTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FilmTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = FilmTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = FilmTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
