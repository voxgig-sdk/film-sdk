...
// Film SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class FilmTestFeature extends FilmBaseFeature
{
    ...
    public function init(FilmContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (FilmContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (FilmContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(FilmContext $ctx, $op, $args): array
    {
