...
class FilmCacheFeature extends FilmBaseFeature
{
    ...
    private function _through(FilmContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
