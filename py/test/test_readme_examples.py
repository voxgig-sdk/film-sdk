# Film SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FilmSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FilmSDK(...) and FilmSDK.test(...) become
#      FilmSDK.test({"entity": {...}}) seeding one mock record (id "test01")
