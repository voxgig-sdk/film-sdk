...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/film` | `npm install @voxgig-sdk/film` |
| Python | `voxgig-sdk-film` | `pip install voxgig-sdk-film` |
| PHP | `voxgig-sdk/film` | `composer require voxgig-sdk/film` |
| Golang | `github.com/voxgig-sdk/film-sdk/go` | `go get github.com/voxgig-sdk/film-sdk/go` |
| Ruby | `voxgig-sdk-film` | `gem install voxgig-sdk-film` |
| Lua | `voxgig-sdk-film` | `luarocks install voxgig-sdk-film` |
