...
func (sdk *FilmSDK) OptionsMap() map[string]any {
...
func (sdk *FilmSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *FilmSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *FilmSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FilmSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *FilmSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *FilmSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("FilmSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *FilmSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FilmSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("FilmSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
