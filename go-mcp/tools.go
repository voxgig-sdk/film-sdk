...
type Args struct {
	Entity string         `json:"entity" jsonschema:"film"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.FilmSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "film_list",
		Description: "List records from Film. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "film_load",
		Description: "Load a single record from Film. " +
...
func runOp(client *sdk.FilmSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FilmSDK, name string) (sdk.FilmEntity, error) {
