...
from film_sdk.utility import register

# Load features
from film_sdk.feature.base_feature import FilmBaseFeature
from film_sdk.features import _has_feature, _make_feature
...
class FilmSDK:
    ...
    def get_utility(self):
        return FilmUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FilmSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Film(self, data=None) -> "FilmEntity":
        ...
        from film_sdk.entity.film_entity import FilmEntity
