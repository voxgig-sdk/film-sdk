...
class FilmTestRunner
{
    ...
    {
        $live = self::getenv('FILM_TEST_LIVE');
        $override = self::getenv('FILM_TEST_OVERRIDE');
        ...
        $explain = self::getenv('FILM_TEST_EXPLAIN');
...
class_alias('FilmTestRunner', 'Runner');
class_alias('FilmHelpers', 'Helpers');
