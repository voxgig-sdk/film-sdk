# Film TypeScript SDK Reference

Complete API reference for the Film TypeScript SDK.
...
**Returns:** `FilmSDK` instance in test mode.
...
Return the parent `FilmSDK` instance.
