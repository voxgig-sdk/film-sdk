...
module FilmTestRunner
  ...
  def self.env_override(m)
    live = getenv("FILM_TEST_LIVE")
    override = getenv("FILM_TEST_OVERRIDE")
    ...
    explain = getenv("FILM_TEST_EXPLAIN")
    m["FILM_TEST_EXPLAIN"] = explain if explain && !explain.empty?
