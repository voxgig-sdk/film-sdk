...
class FilmStreamingFeature extends FilmBaseFeature
{
    ...
    private function _iterate(FilmResult $result): \Generator
    {
    ...
    private function _streamable(FilmContext $ctx): bool
    {
