...
The Lua SDK for the Film API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/film-sdk/releases)),
...
The main module (`film_sdk`) exports the SDK constructor
