...
class FilmRbacFeature extends FilmBaseFeature
{
    ...
    private function _required(FilmContext $ctx): ?string
    {
    ...
    private function _reject(FilmContext $ctx, string $required): void
    {
    ...
    private function _track(FilmContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
