...
The TypeScript SDK for the Film API — a type-safe, entity-oriented client with full async/await support.
...
- Releases: [https://github.com/voxgig-sdk/film-sdk/releases](https://github.com/voxgig-sdk/film-sdk/releases)
...
| `tester(testopts?, sdkopts?)` | `FilmSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `FilmSDK.test(testopts?, sdkopts?)` | `FilmSDK` | Create a test-mode client. |
...
| `client` | `client(): FilmSDK` | Return the parent SDK client. |
