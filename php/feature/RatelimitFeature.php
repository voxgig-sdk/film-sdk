...
class FilmRatelimitFeature extends FilmBaseFeature
{
    ...
    private function _acquire(FilmContext $ctx): void
    {
    ...
    private function _track(FilmContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
