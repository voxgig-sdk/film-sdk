...
// Film SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FilmSDK::test)
...
{
    private const SDK_CLASS = 'FilmSDK';
    ...
    private const SDK_BASE = 'film_sdk';
